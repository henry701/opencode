...
describe("public event manifest", () => {
  ...
  test("uses canonical definitions for current public events", () => {
    ...
    expect(EventManifest.Latest.get("session.queue.updated")).toBe(SessionV1.Event.QueueUpdated)
    expect(EventManifest.Definitions).toContain(SessionV1.Event.QueueUpdated)
