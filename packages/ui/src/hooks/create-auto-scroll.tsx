...
export function createAutoScroll(options: AutoScrollOptions) {
  ...
  let layoutScrollFrame: number | undefined

  const markLayoutScroll = () => {
    if (layoutScrollFrame !== undefined) cancelAnimationFrame(layoutScrollFrame)
    layoutScrollFrame = requestAnimationFrame(() => {
      layoutScrollFrame = undefined
    })
  }
  ...
  createResizeObserver(
    ...
    () => {
      ...
      if (scrollEl && distanceFromBottom(scrollEl) > threshold()) return
