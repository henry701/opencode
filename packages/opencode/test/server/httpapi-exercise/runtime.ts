export type Runtime = {
  ...
  SessionPromptQueue: (typeof import("../../../src/session/prompt-queue"))["SessionPromptQueue"]
...
export function runtime() {
  return (runtimePromise ??= (async () => {
    ...
    const sessionPromptQueue = await import("../../../src/session/prompt-queue")
    ...
    return {
      ...
      SessionPromptQueue: sessionPromptQueue.SessionPromptQueue,
      Todo: todo.Todo,
