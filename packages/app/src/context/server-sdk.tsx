...
import { createCurrentClientForServer, type CurrentClient } from "@/utils/current-client"
...
function createServerSdkContextBase(server: ServerConnection.Any, scope: ServerScope): ServerSDKBase {
  ...
  const currentClient = createCurrentClientForServer({ server: server.http, fetch: platform.fetch })
